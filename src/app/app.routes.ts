...
export const routes: Routes = [
  ...
  { path: 'tarjetas',     canActivate: [authGuard], loadComponent: () => import('./pages/gestion-tarjetas/gestion-tarjetas').then(m => m.GestionTarjetas) },
  { path: 'historial',    canActivate: [authGuard], loadComponent: () => import('./pages/historial-accesos/historial-accesos').then(m => m.HistorialAccesos) },
  ...
  { path: 'mensajes',    canActivate: [authGuard], loadComponent: () => import('./pages/mensajes/mensajes').then(m => m.Mensajes) },
  { path: 'soporte',     canActivate: [authGuard], loadComponent: () => import('./pages/soporte-usuario/soporte-usuario').then(m => m.SoporteUsuario) },
  { path: 'credencial/:id', canActivate: [authGuard], component: DetalleCredencial },
  { path: 'ubicacion',   canActivate: [authGuard], loadComponent: () => import('./pages/ubicacion/ubicacion').then(m => m.Ubicacion) },
  ...
  // ── ADMIN (protegido) ──────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { path: 'dashboard',             loadComponent: () => import('./pages/admin/dashboard-admin/dashboard-admin').then(m => m.DashboardAdmin) },
      ...
      { path: 'mi-institucion',        loadComponent: () => import('./pages/admin/mi-institucion/mi-institucion').then(m => m.MiInstitucion) },
      ...
      { path: 'administradores',       loadComponent: () => import('./pages/admin/administradores/administradores').then(m => m.Administradores) },
      ...
      { path: 'credenciales',          loadComponent: () => import('./pages/admin/credenciales/credenciales').then(m => m.Credenciales) },
